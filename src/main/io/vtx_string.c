...
#define VTX_STRING_3G3_BAND_COUNT  2
...
{
    { 3320, 3345, 3370, 3395, 3420, 3445, 3470, 3495 }, // A
    { 3310, 3330, 3355, 3380, 3405, 3430, 3455, 3480 }, // B
};
...
const char vtx3G3BandLetter[VTX_STRING_3G3_BAND_COUNT + 1] = "-AB";
